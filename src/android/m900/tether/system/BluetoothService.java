package android.m900.tether.system;
	...
	public static BluetoothService getInstance() {
	    if (bluetoothService == null) {
	        ...
	        if (sdkVersion < Build.VERSION_CODES.ECLAIR) {
	            className = "android.m900.tether.system.BluetoothService_cupcake";
	        } else {
	            className = "android.m900.tether.system.BluetoothService_eclair";
	        }
